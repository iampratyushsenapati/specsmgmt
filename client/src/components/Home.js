...
const Home = () => {
  return (
    <div className='w-full h-screen'>
      <img
        className='top-0 left-0 w-full h-screen object-cover' src={view} alt="/"
      />
      <div className='bg-black/30 absolute top-0 mt-[4.5rem] left-0 h-screen w-full' />

      <div className='absolute top-0 w-full h-full  flex flex-col justify-center text-white '>
        <div className='md-left-[10%] max-w-[1100px]  w-full h-screen  mx-auto  mt-[96px]  m-auto absolute p-4  text-center'>
          <h1 className='md:text-7xl sm:text-6xl text-4xl font-bold md:py-6  m-[20px] text-center'>Welcome Here</h1>
